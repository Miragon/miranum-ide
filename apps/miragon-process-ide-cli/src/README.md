...
```
npm install @miragon/miragon-process-ide-cli
```
...
npx @miragon/miragon-process-ide-cli deploy -d . -t dev

# deploy project example-project to env prod
npx @miragon/miragon-process-ide-cli deploy -d path/to/example-project -t dev
```
...
```bash
# deploy project to target env dev
npx @miragon/miragon-process-ide-cli deploy-file -f resources/my-process-automation-project/my-process.bpmn -t dev --type bpmn
```

**Generate new project**

```bash
npx @miragon/miragon-process-ide-cli generate --name my-awesome-project --path .
```
