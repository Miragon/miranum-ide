...
//     }
//
//     return extensionElements.get("values").filter((value: any) => {
//         return isAny(value, types);
//     });
// }
//
// export function findCamundaProperty(camundaProperties: any, binding: any) {
//     return camundaProperties.get("properties").find((value: any) => {
