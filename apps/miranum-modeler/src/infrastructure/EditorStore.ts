...
import { getContext } from "@miranum-ide/miranum-vscode";
import { Command, Query } from "@miranum-ide/miranum-vscode-webview";
...
const DMN_VIEW_TYPE = "miranum-modeler.dmn";
/** VS Code `setContext` command key used by keybinding/menu `when` clauses. */
const OPEN_EDITORS_COUNTER_KEY = "miranum-modeler.openCustomEditors";
...
export class EditorStore {
     ...
     *
     * @param viewType VS Code view-type identifier (e.g. `"miranum-modeler.bpmn"`).
