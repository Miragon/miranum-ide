...
class DeploymentControllerTest {
    ...
    void deployTest() {
        ...
        Mockito.when(this.deployFile.deploy(deployment)).thenReturn(DeploymentStatus.builder()
            .success(true)
            .message("test")
            .build());
        final DeploymentStatus result = this.deploymentController.deploy(deployment);
